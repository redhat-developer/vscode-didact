...
## 0.1.9
 ...
 - Adding key binding to Start Didact command (Ctrl+Alt+D or Ctrl+Cmd+D) when a Didact file is open in an editor to quickly open the Didact window with the selected file
