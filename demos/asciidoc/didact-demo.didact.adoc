...
* link:didact://?commandId=vscode.didact.openNamedOutputChannel&name=newOutputChannel&text=Hello%20from%20Didact!&completion=Opened%20a%20new%20output%20channel.[You can also open an output channel, name it, and send it some text.]
