...
> Note that the link above does not currently work. [We are investigating](https://issues.redhat.com/browse/FUSETOOLS2-706) -- the workaround is to manually copy and paste the text into your document.
